                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack {
                        ...
                        HStack {
                            ...
                            .onAppear() {
                                self.published = movie.published!
                            }
                        ...
                        Button {
                            ...
                            if name != "" && description != "" {
                                if url.count > 0 {
                                    self.movieModel.updateMovieDatabyTrailersLink(link: movie.TrailerUrl!, imageUrl: imageUrl, trailerUrl: url[0].url!, name: name, age: age, published: published, category: category, description: description, director: director, actors: actors)
                                } else {
                                    self.movieModel.updateMovieDatabyTrailersLink(link: movie.TrailerUrl!, imageUrl: imageUrl, trailerUrl: "", name: name, age: age, published: published, category: category, description: description, director: director, actors: actors)
                                }
